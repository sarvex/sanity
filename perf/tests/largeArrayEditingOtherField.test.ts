...
export default {
  id: KNOWN_TEST_IDS['large-array-editing-other-field'],
  name: 'Performance test of array with 200 items and editing another field',
  description: `
  This test measures the general performance of an array with 1k items. It also measures the performance of editing another field.
  `,
  metrics: {
    lagPerKeystroke: {
      title: 'Lag',
